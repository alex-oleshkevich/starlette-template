...
async def register_user(
    ...
    *,
    ...
    subscription = Subscription(
        ...
        team=team,
        auto_renew=auto_renew_subscription,
        status=subscription_status,
        subscribed_until=datetime.datetime.now(datetime.UTC) + subscription_duration,
    )
    dbsession.add_all([user, team, team_role, team_member, subscription])
